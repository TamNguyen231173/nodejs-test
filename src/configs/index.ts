...
// Database
export const MONGO_DB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/game-management'
...
export const REFRESH_TOKEN_LIFE = process.env.REFRESH_TOKEN_LIFE || 60 * 60 * 24 * 30
export const EMAIL_ADMIN = process.env.EMAIL_ADMIN || 'admin@gmail.com'
export const PASSWORD_ADMIN = process.env.PASSWORD_ADMIN || 'admin123'
